...
function EditorSlider({ templateAble, uploadAble, uploadSwitch }) {
  ...
  return (
    <div className="editorSliderMain">
      ...
      {uploadAble === true ? (
        <div className="uploadConditionalContainer">
          {isChecked === true ? (
            <div className="documentUploadContainer" id="selectedOption">
              <label
                className="documentUploadLabel"
                htmlFor="documentLoadInput"
              >
            ...
            >
              <label
                className="documentUploadLabelNoPointer"
                htmlFor="documentLoadInput"
              >
                <p>Seleccionar documento(pdf)</p>
