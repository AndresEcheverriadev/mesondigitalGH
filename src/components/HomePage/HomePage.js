  ...
  return (
    ...
    <div className='homePageMainContainer'>
        ...
        <section className="searchContainer">
          <h1>Resuelva sus trámites en menos tiempo.</h1>
          <h1>Seleccione su documento en línea.</h1>
          <div className='searchBar'>
            <div class="searchBarInput form-floating">
              ...
              <label for="floatingSearch">¿Qué trámite busca?</label>
            </div>
    ...
    <footer>
      <div className="footerContainer">
        <div className='footerLogo'>
          <img src={logoVerticalBlanco} alt="" />
        </div>

        <div className='footerLinksContainer'>
          <NavLink to='/' className='footerLink' >¿Quiénes somos?</NavLink>
        </div>

        <div className='footerLinksContainer'>
          <NavLink to='/' className='footerLink' >Preguntas frecuentes</NavLink>
        </div>

        <div className='footerLinksContainer linkRRSS'>
