...
import logoSello from '../../images/logoSello.svg';
import './HomePage.css';
...
function HomePage() {
  return (
    <section className='homePageMainContainer'>
        ...
        <div className="main"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag-x-fill botonbag" viewBox="0 0 16 16">
